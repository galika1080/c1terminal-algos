...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def initial_defense(self, game_state):
        ...
        wall_loc = [[1, 13], [2, 13], [3, 13], [4, 13], [5, 13], [8, 13], [19, 13], [22, 13], [23, 13], [24, 13], [25, 13], [26, 13], [9, 12], [18, 12], [10, 11], [17, 11], [11, 10], [16, 10], [12, 9], [15, 9], [13, 8], [14, 8]]
    ...
    def spd_strat_main(self, game_state, my_seed):
        ...
        if game_state.turn_number <= 10 or game_state.get_resource(SP) >=14:
            if game_state.turn_number <= 10:
                num_factory = int(game_state.get_resource(SP)*0.8/game_state.type_cost(FACTORY)[SP])
            else:
                num_factory = int(game_state.get_resource(SP)*0.5/game_state.type_cost(FACTORY)[SP])
            counter = 0
            factory_locations = [[13, 0], [14, 0], [12, 1], [13, 1], [14, 1], [15, 1],[11, 2], [12, 2], [13, 2], [14, 2], [15, 2], [16, 2]]

            for location in factory_locations:
                if game_state.attempt_spawn(FACTORY, location) == 1:
                    counter += 1
